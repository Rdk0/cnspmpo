...
"file https://github.com/Merck/pmpo/tree/master/pMPO/tests/assets/CNS_pMPO.df.pkl"
file_name = "CNS_pMPO.df.pkl"
df = pd.read_pickle(file_name)
df.to_csv("CNS_pMPO.df.csv")
...
df2 = pd.DataFrame.from_dict(REFERENCE_CNS_PMPO_VALUES, orient='index')
df2.to_csv('cns_pmpo_values.csv', index=True, index_label='Drug')